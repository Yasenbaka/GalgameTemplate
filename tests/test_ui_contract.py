...
class UiContractTests(unittest.TestCase):
    def test_generated_files_contain_required_runtime_hooks(self) -> None:
        ...
        self.assertIn('textbutton _("Start")', main_menu)
        self.assertIn('textbutton _("Load")', main_menu)
        self.assertIn('textbutton _("Settings")', main_menu)
        self.assertIn('textbutton _("Exit")', main_menu)

        self.assertIn('key "mouseup_3" action Function(toggle_interface)', hud)
        self.assertIn('textbutton _("SAVE")', hud)
        self.assertIn('textbutton _("LOAD")', hud)
        self.assertIn('textbutton _("CONFIG")', hud)
        self.assertIn('textbutton _("EXIT")', hud)
        self.assertIn('textbutton _("History")', hud)
        self.assertIn('textbutton _("Auto")', hud)
        self.assertIn('textbutton _("Pause")', hud)
