...
EXPECTED_FILES = {
    ...
    Path("game/41_screens_say.rpy"),
    Path("game/42_screens_hud.rpy"),
    Path("game/43_screens_save_load.rpy"),
    Path("game/44_screens_preferences.rpy"),
    Path("game/45_screens_history.rpy"),
    Path("game/46_screens_confirm.rpy"),
    Path("game/50_script_prologue.rpy"),
    Path("game/images/backgrounds/.gitkeep"),
    Path("game/images/characters/.gitkeep"),
    Path("game/images/ui/.gitkeep"),
